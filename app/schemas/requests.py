...
class StartRequest(BaseModel):
    ...
    def validate_symbols(cls, v: list[str]) -> list[str]:
        ...
        valid_symbols = {
            ...
            "HINDUNILVR", "ICICIBANK", "SBIN", "LANDT", "AXISBANK",
            "MARUTI", "ASIANPAINT", "ULTRAMARINE", "BRITANNIA", "NESTLEIND",
            "DRREDDY", "SUNPHARMA", "CIPLA", "LUPIN", "INDIGO",
            # Add more as needed
        }
    ...
    def validate_loss(cls, v: float, info) -> float:
        ...
        if 'capital' in info.data:
            ...
            if v > max_allowed_loss:
                raise ValueError(
                    f"Max daily loss (₹{v}) cannot exceed 20% of capital "
    ...
    def validate_strategy(cls, v: str) -> str:
        ...
        if v not in valid_strategies:
            raise ValueError(
                f"Strategy '{v}' not found. Available: {valid_strategies}"
            )
        return v
