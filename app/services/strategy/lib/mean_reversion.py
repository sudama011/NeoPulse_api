...
from app.services.strategy.indicators import calculate_rsi, calculate_bollinger_bands
...
class MeanReversionStrategy(BaseStrategy):
    ...
    async def on_candle_close(self, candle: dict) -> None:
        ...
        bb_upper, bb_lower = await run_blocking(calculate_bollinger_bands, safe_candles, self.bb_period, self.bb_std_dev)
